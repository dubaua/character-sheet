...
character.abilities.get(AbilityEnum.Dexterity)!.setValue(17 + 1).setSavingThrowProficiency(true);
character.abilities.get(AbilityEnum.Charisma)!.setValue(16 + 2).setSavingThrowProficiency(true);
character.abilities.get(AbilityEnum.Intelligence)!.setValue(15);
character.abilities.get(AbilityEnum.Constitution)!.setValue(13);
character.abilities.get(AbilityEnum.Strength)!.setValue(12);
character.abilities.get(AbilityEnum.Wisdom)!.setValue(11);
...
character.speed = 35;
character.hitDie = 8;
character.hitLevelUpRolls = [5,5,5];
